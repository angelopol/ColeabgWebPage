...
<html>
    <head>
        ...
        <title>Cancelled Operations</title> <!--title of page-->
...
$connectionInfo = array( "Database"=>"db_aa07eb_coleabg", "UID"=>"db_aa07eb_coleabg_admin", "PWD"=>"$0p0rt3ca" ,'ReturnDatesAsStrings'=>true);
                                ...
                                $consultusers = "SELECT * FROM SOLV where NumeroD < CONVERT(INT, '5000') ORDER BY NumeroD";
