    ...
    ">
            <div class="container">
                <div class="row min-vh-100 justify-content-center align-items-center">
                    ...
                    <h1 class="text-light text-center">Carnet Familiar</h1>
                    <br>
        <form action="SetCarnetNumFamily2.php" method="post">
        <br>
            ...
            <div class="form-floating mb-3"> 
                        ...
                        <input type="text"  name="AbgCi" class="form-control" placeholder="name@example.com" required> 
                        <label for="floatingInput">Cedula Abogado</label>
            </div>
            ...
            <div class="form-floating mb-3"> 
                        ...
                        <input type="text"  name="direccion" class="form-control" placeholder="name@example.com" required> 
