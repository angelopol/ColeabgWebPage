        ...
        <div class="col-auto p-5">
            <form action="system.php" method="post">
                <div class="form-floating mb-3">
                    <input type="number" name="input" max="99999999" class="form-control" required>
            ...
            <form action="index.php">
                <label for="buttom" class="form-label"><span class="text-light">Ej: 12345678, 2023</span></label>
