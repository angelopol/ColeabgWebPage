...
<html>
    ...
    ">
        ...
        <br>
            ...
            <input type="number"  name="input" max="999999" class="form-control" placeholder="name@example.com" required> 
    ...
    <div class="form-floating mb-3"> 
        ...
        <input type="submit" class="btn btn-outline-success w-100" value="Buscar por cedula">
        </form>
        <br>
        <form action='index.php'>
            <label for="buttom" class="form-label"><p class="text-light">Ej: 211210, 2023</p></label>
