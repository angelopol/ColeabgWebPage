...
<html>
    <head>
        ...
        <title>Persons without Name or Direction</title> <!--title of page-->
...
require './conn.php'; $conn = sqlsrv_connect(DataConnect()[0], DataConnect()[1]);
                                ...
                                $consultusers = "SELECT * FROM SOLV where Status = 1 AND (Name IS NULL or Direccion IS NULL)";
                                ...
                                if ($nullornotusers == false) 
                                ...
                                else
                                    {
                                        ...
                                        No found persons without Name or Direction.
                                        </div>";
                                    }
