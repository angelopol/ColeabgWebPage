...
<html>
    <head>
        ...
        <title>Duplicates for CarnetNum</title> <!--title of page-->
...
require './conn.php'; $conn = sqlsrv_connect(DataConnect()[0], DataConnect()[1]);
                                ...
                                $consultusers = "SELECT CarnetNum2, COUNT(CarnetNum2) FROM SOLV WHERE Status = 1 AND CarnetNum2 != 'None' GROUP BY CarnetNum2 HAVING COUNT(CarnetNum2) > 1";
                                ...
                                if ($nullornotusers == false) 
                                    {   
                                        ...
                                        while( $rowclieusers = sqlsrv_fetch_array( $stmt1, SQLSRV_FETCH_ASSOC) ) 
                                        {
                                            ...
                                            echo "<li class='list-group-item'>" . $rowclieusers['CarnetNum2'] . "</li>";
                                ...
                                else
                                    {
                                        ...
                                        No found duplicates for CarnetNum.
                                        </div>";
                                    }
