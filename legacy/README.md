...
## Nueva App Nuxt (Migracion)
- Se creo una nueva aplicacion full-stack en `nuxt-app/`.
- Frontend: Vue 3 + Tailwind CSS.
- Backend: Nuxt Server API con SQL Server.
- Ver documentacion en `nuxt-app/README.md` y `nuxt-app/MIGRATION_MAP.md`.
