      ...
      <div class="offcanvas-body">
        <ul class="navbar-nav justify-content-end flex-grow-1 pe-3">
          ...
          <li class="nav-item">
            ...
            <form action="recpass2.php" method="post">
                ...
                <input name="contra" type="password" class="form-control" aria-describedby="inputGroup-sizing-sm" placeholder="Antigua contraseña" pattern=".{8,}" required>
                ...
                <input name="contranew" type="password" class="form-control" aria-describedby="inputGroup-sizing-sm" placeholder="Minimo 8 caracteres" pattern=".{8,}" required>
                
                
                <input name="contranew2" type="password" class="form-control" placeholder="Confirmar" aria-describedby="inputGroup-sizing-sm" pattern=".{8,}" required>
